...
describe('TypePlante e2e test', () => {
  ...
  describe('new TypePlante page', () => {
    ...
    it('should create an instance of TypePlante', () => {
      cy.get(`[data-cy="humiditeMin"]`).type('30163').should('have.value', '30163');

      cy.get(`[data-cy="humiditeMax"]`).type('18847').should('have.value', '18847');

      cy.get(`[data-cy="temperatureMin"]`).type('64805').should('have.value', '64805');

      cy.get(`[data-cy="temperatureMax"]`).type('54250').should('have.value', '54250');

      cy.get(`[data-cy="limunosite"]`).type('75969').should('have.value', '75969');

      cy.get(`[data-cy="libelle"]`).type('Buckinghamshire implement').should('have.value', 'Buckinghamshire implement');
