...
describe('Plante e2e test', () => {
  ...
  describe('new Plante page', () => {
    ...
    it('should create an instance of Plante', () => {
      cy.get(`[data-cy="libelle"]`).type('Miquelon quantifying').should('have.value', 'Miquelon quantifying');

      cy.get(`[data-cy="photo"]`).type('deposit Minnesota Chicken').should('have.value', 'deposit Minnesota Chicken');
