...
class UtilisateurResourceIT {
    ...
    void createUtilisateur() throws Exception {
        ...
        assertThat(testUtilisateur.getPhoto()).isEqualTo(DEFAULT_PHOTO);
    ...
    void putNewUtilisateur() throws Exception {
        ...
        updatedUtilisateur.nom(UPDATED_NOM).prenom(UPDATED_PRENOM).photo(UPDATED_PHOTO).password(UPDATED_PASSWORD).email(UPDATED_EMAIL);
        ...
        assertThat(testUtilisateur.getPhoto()).isEqualTo(UPDATED_PHOTO);
